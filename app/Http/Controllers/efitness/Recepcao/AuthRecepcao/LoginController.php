...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $this->middleware('guest:recepcao')->except('logout');
    }
    ...
    {
        return view('efitness.Recepcao.auth-recepcao.login');
    }
    ...
    public function logout(Request $request)
    {
        ...
        return $this->loggedOut($request) ?: redirect(route('efitness.recepcao.login'));
    }
