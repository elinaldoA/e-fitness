...
class RecepcaoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('efitness/Administrativo/recepcao/novo', ['sexos' => $sexos, 'estados_civils' => $estados_civils, 'cargos' => $cargos]);
    }
    ...
    public function edit($id)
    {
        ...
        ['recepcaos' => $recepcaos, 'sexos' => $sexos, 'estados_civils' => $estados_civils, 'enderecos' => $enderecos, 'cargos' => $cargos]);
    }
