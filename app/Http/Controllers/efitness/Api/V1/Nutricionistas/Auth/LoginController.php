...
use App\Http\Resources\V1\Nutricionistas as NutricionistaResource;
...
/*        $nutricionistaUser = $this->guard()->user();

        if (!$nutricionistaUser->hasVerifiedEmail()) {
    ...
    protected function sendLoginResponse()
    {
        ...
        $nutricionista = $this->guard()->user();

        return response([
            'user' => new NutricionistaResource($nutricionista),
            'token' => $token
        ], Response::HTTP_OK);
    }
