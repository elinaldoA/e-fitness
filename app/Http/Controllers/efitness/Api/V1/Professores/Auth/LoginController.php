...
use App\Http\Resources\V1\Professores as ProfessorResource;
...
/*        $professorUser = $this->guard()->user();

        if (!$professorUser->hasVerifiedEmail()) {
    ...
    protected function sendLoginResponse()
    {
        ...
        return response([
            'user' => new ProfessorResource($professor),
            'token' => $token
        ], Response::HTTP_OK);
    }
