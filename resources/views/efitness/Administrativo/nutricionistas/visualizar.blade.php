                ...
                <div class="card-body">
                    <table class="table table-hover text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-primary" href="{{ route('Alterar_nutricionista', ['id' => $nutricionista-> id]) }}"><i class="fa fa-edit"></i></a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger btn-ok" href="{{ route('excluir_nutricionista', ['id' => $nutricionista-> id]) }}">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
