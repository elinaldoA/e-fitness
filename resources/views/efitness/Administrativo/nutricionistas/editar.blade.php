                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="nome" class="form-control" name="nome" placeholder="Nome fantasia" value="{{$nutricionistas->nome}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <input type="password" class="form-control" name="password" id="password" value="{{$nutricionistas->password}}">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group focused">
