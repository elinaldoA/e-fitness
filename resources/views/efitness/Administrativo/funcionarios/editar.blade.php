    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('Alterar_funcionario', ['id' => $funcionarios->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-1">
                                    <div class="form-group focused">
                                        ...
                                        <input type="checkbox" name="active" value="1" class="form-control"
                                           @if( ($funcionarios->active == 0 && old('active') && old('first_time')) || ($funcionarios->active && old('active') == null && old('first_time') == null) || ($funcionarios->active && old('active') && old('first_time') ) )
                                           checked="checked"
                                        @endif
                                    >
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <select name="cargos_id" id="cargos_id" class="form-control">
                                            ...
                                            <option {{ $funcionarios->cargos_id == $cargo->id ? 'selected' : '' }}  value="{{ $cargo->id }}">{{$cargo->nome}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <input name="sexo" id="sexos" class="form-control" value="{{$funcionarios->sexos}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        onkeyup="somenteNumeros(this);" value="{{$funcionarios->cpf}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group focused">
                                        ...
                                        <br />
                                        <img src="/image/{{ $funcionarios->image }}" width="200px" class="img-thumbnail">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('funcionarios')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
