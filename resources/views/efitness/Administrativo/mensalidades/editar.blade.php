    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Editar Mensalidade</h6>
            </div>

            <div class="card-body">

                <form method="POST" action="{{ route('Alterar_mensalidade', ['id' => $mensalidades->id]) }}" autocomplete="off">
                    @csrf
                    <div class="pl-lg-12">
                        <div class="col-lg-6">
                            <div class="form-group focused">
                                <label class="form-control-label" for="nome">Nome<span class="small text-danger"> * </span></label>
                                <input type="text" id="nome" class="form-control" name="nome" placeholder="Auxiliar, Recepção" value="{{$mensalidade->alunos_id}}">
                            </div>
                        </div>
                    </div>
                    <!-- Button -->
