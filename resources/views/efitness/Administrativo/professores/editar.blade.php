                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <input name="s" id="sexos" class="form-control" value="{{$professores->sexos}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('professores')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
