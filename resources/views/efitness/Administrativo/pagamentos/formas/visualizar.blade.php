            ...
            <div class="card-header py-3">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover text-center">
                        ...
                        @forelse ($formaPags as $formaPag)
                        <tr>
                            <td>{{ $formaPag -> status }}</td>
                            <td>{{ $formaPag -> forma_de_pagamento }}</td>
                            <td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger btn-ok" href="{{ route('excluir_forma_de_pagamento', ['id' => $formaPag-> id]) }}">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
