    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('Alterar_recepcao', ['id' => $recepcaos->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-1">
                                    <div class="form-group focused">
                                        ...
                                        <input type="checkbox" name="active" value="1" class="form-control"
                                           @if( ($recepcaos->active == 0 && old('active') && old('first_time')) || ($recepcaos->active && old('active') == null && old('first_time') == null) || ($recepcaos->active && old('active') && old('first_time') ) )
                                           checked="checked"
                                        @endif
                                    >
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="nome" class="form-control" name="nome" placeholder="Seu nome" value="{{$recepcaos->nome}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="nome">Sobrenome<span class="small text-danger"> * </span></label>
                                        <input type="text" id="sobrenome" class="form-control" name="sobrenome" placeholder="Seu sobrenome" value="{{$recepcaos->sobrenome}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <select name="cargos_id" id="cargos_id" class="form-control">
                                            ...
                                            <option {{ $recepcaos->cargos_id == $cargo->id ? 'selected' : '' }}  value="{{ $cargo->id }}">{{$cargo->nome}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <select name="sexos_id" id="sexos_id" class="form-control">
                                            ...
                                            <option {{ $recepcaos->sexos_id == $sexo->id ? 'selected' : '' }}  value="{{ $sexo->id }}">{{$sexo->nome}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <select name="estado_civil_id" id="estado_civil_id" class="form-control">
                                            ...
                                            <option {{ $recepcaos->estado_civils_id == $estadoCivil->id ? 'selected' : '' }}  value="{{ $estadoCivil->id }}">{{$estadoCivil->nome}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <input type="date" class="form-control" id="nascimento" name="nascimento" value="{{$recepcaos->nascimento}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group focused">
                                        ...
                                        <br />
                                        <img src="/image/{{ $recepcaos->image }}" width="200px" class="img-thumbnail">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('recepcao.create')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
