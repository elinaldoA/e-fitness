                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <input name="sexo" id="sexo" class="form-control" value="{{$recepcaos->sexo}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="estado_civil_id">Estado cívil<span class="small text-danger"> * </span></label>
                                        <input name="estado_civil" id="estado_civil" class="form-control" value="{{$recepcaos->estado_civil}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
