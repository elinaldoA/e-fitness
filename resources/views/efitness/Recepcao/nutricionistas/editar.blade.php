    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('Alterar_recepcao_nutri', ['id' => $nutricionistas->id], ['id' => $enderecos->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-1">
                                    <div class="form-group focused">
                                        ...
                                        <input type="checkbox" name="active" value="1" class="form-control"
                                           @if( ($nutricionistas->active == 0 && old('active') && old('first_time')) || ($nutricionistas->active && old('active') == null && old('first_time') == null) || ($nutricionistas->active && old('active') && old('first_time') ) )
                                           checked="checked"
                                        @endif
                                    >
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="nome" class="form-control" name="nome" placeholder="Seu nome" value="{{$nutricionistas->nome}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="nome">Sobrenome<span class="small text-danger"> * </span></label>
                                        <input type="text" id="sobrenome" class="form-control" name="sobrenome" placeholder="Seu sobrenome" value="{{$nutricionistas->sobrenome}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <select name="cargos_id" id="cargos_id" class="form-control">
                                            ...
                                            <option {{ $nutricionistas->cargos_id == $cargo->id ? 'selected' : '' }}  value="{{ $cargo->id }}">{{$cargo->nome}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <input name="sexos" id="sexos" class="form-control" value="{{$nutricionistas->sexos}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="estado_civil_id">Estado cívil<span class="small text-danger"> * </span></label>
                                        <input name="estado_civil" id="estado_civil" class="form-control" value="{{$nutricionistas->estado_civil}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="nascimento">Nascimento<span class="small text-danger"> * </span></label>
                                        <input type="date" class="form-control" id="nascimento" name="nascimento" value="{{$nutricionistas->nascimento}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        onkeyup="somenteNumeros(this);" value="{{$nutricionistas->cpf}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group focused">
                                        ...
                                        <br />
                                        <img src="/image/{{ $nutricionistas->image }}" width="200px" class="img-thumbnail">
                                    </div>
                                </div>
                            </div>
                        </div>
