...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Consultas Agendadas') }}</h1>
            ...
            <div class="card-header py-3">
                ...
                <div class="card-body">
                    <table class="table table-hover text-center">
                        ...
                        @forelse ($consultas_nutricionais as $consulta_nutricional)
                        <tr>
                            @foreach($alunos as $aluno)
                            @if($aluno->id == $consulta_nutricional->alunos_id)
                            ...
                            <td>
                                <a class="btn btn-outline-primary" href="{{ route('Alterar_consulta_aluno', ['id' => $consulta_nutricional-> id]) }}"><i class="fa fa-edit"></i></a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger btn-ok" href="{{ route('excluir_consulta_aluno', ['id' => $consulta_nutricional-> id]) }}">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
