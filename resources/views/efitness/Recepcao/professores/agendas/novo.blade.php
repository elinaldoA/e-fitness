...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Agenda Professores') }}</h1>
    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('agendas_professores.create') }}" class="Cargos">
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('agendas_professores')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> Voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
