    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('Alterar_recepcao_prof', ['id' => $professores->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="nome" class="form-control" name="nome" placeholder="Seu nome" value="{{$professores->nome}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="nome">Sobrenome<span class="small text-danger"> * </span></label>
                                        <input type="text" id="sobrenome" class="form-control" name="sobrenome" placeholder="Seu sobrenome" value="{{$professores->sobrenome}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <select name="cargos_id" id="cargos_id" class="form-control">
                                            ...
                                            <option {{ $professores->cargos_id == $cargo->id ? 'selected' : '' }}  value="{{ $cargo->id }}">{{$cargo->nome}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <input name="estado_civil" id="estado_civil" class="form-control" value="{{$professores->estado_civil}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('recepcao_prof.create')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
