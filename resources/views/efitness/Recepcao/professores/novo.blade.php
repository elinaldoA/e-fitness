    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user-graduate"></i> Adicionar nova</h6>
            </div>

            <div class="card-body">

            <form method="POST" action="{{ route('recepcao_prof.create') }}" class="professores" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="password">E-mail<span class="small text-danger"> * </span></label>
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('recepcao_prof')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
