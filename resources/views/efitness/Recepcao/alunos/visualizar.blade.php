                ...
                <div class="card-body">
                    <table class="table table-hover text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-primary" href="{{ route('Alterar_recepcao_aluno', ['id' => $aluno-> id]) }}"><i class="fa fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger btn-ok" href="{{ route('excluir_recepcao_aluno', ['id' => $aluno-> id]) }}">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
