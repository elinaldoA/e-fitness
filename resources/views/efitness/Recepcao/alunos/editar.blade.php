    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('Alterar_recepcao_aluno', ['id' => $alunos->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                        ...
                                        <input type="email" id="email" class="form-control" name="email" placeholder="example@servidor.com.br" value="{{$alunos->email}}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group focused">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <br />
                                        <img src="/image/{{ $alunos->image }}" width="200px" class="img-thumbnail">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('recepcao_alunos.create')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
