...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Editar avaliação') }}</h1>
...
<div class="row">
    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <form method="POST" action="{{ route('Alterar_avaliacao_medida_aluno', ['id' => $medidas->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group focused">
                                    ...
                                    name="coxa_direita" value="{{$medidas->coxa_direita}}">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group focused">
