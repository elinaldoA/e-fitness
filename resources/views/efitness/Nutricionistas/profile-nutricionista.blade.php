    ...
    <div class="col-lg-4 order-lg-2">
        ...
        <div class="card shadow mb-4">
            <div class="card-profile-image mt-4">
                <figure class="rounded-circle avatar avatar font-weight-bold" style="font-size: 60px; height: 180px; width: 180px;" data-initial="{{ Auth::nutricionistas()->nome[0] }}"></figure>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <h5 class="font-weight-bold">{{ Auth::nutricionistas()->fullName }}</h5>
                            <p>Administrator</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-8 order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('efitness.nutricionistas.profile.update') }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Name" value="{{ old('nome', Auth::nutricionistas()->nome) }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="last_name">Sobrenome</label>
                                    <input type="text" id="last_name" class="form-control" name="last_name" placeholder="Last name" value="{{ old('sobrenome', Auth::nutricionistas()->sobrenome) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" class="form-control" name="email" placeholder="example@example.com" value="{{ old('email', Auth::nutricionistas()->email) }}">
                                </div>
                            </div>
                        </div>
