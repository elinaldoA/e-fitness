...
<head>
    ...
    <title>{{ config('app.name', 'E-Fitness | Recepcao') }}</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item {{ Nav::isRoute('home-recepcao') }}">
            <a class="nav-link" href="{{ route('home-recepcao') }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" href="{{ route('efitness.recepcao.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Sair') }}</a>
                <form id="logout-form" action="{{ route('efitness.recepcao.logout') }}" method="POST" style="display: none;">
                    @csrf
                </form>
            </div>
        </div>
